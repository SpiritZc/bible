...
public class TweetDetailsController extends BaseController {
	...
	*/ 
	...
	{
		BaseEntity result = iTweetDetailsService.getDetail(id);
		return result;
	}
	...
	*/ 
	...
	@Check({"title:required#标题;length#标题#200","fromAuthor:required#文章来源作者;length#文章来源作者#100","content:required#推文内容;length#推文内容#65535","img:required#推文图片路径;length#推文图片路径#500",})
	...
	*/ 
	...
	@Check({"id:required#主键ID","title:required#标题;length#标题#200","fromAuthor:required#文章来源作者;length#文章来源作者#100","content:required#推文内容;length#推文内容#65535","img:required#推文图片路径;length#推文图片路径#500",})
