  ...
  data() {
    return{
      pageData:{
        //请求的url start
        requestUrl:{
          listApi:"/api/tweetCollect/getTableList",//获取表格数据api
          insertApi:"/api/tweetCollect/insert",//新增用api
          updateApi:"/api/tweetCollect/update",//更新用api
          getDetailApi:"/api/tweetCollect//getDetail",//获取详情用api
          deleteOneApi:"/api/tweetCollect/delete",//单条删除api
          deleteBatchApi:"/api/tweetCollect/deletebatch",//批量删除api
        },
        //请求的url end
        //查询表单内容 start
        searchForm:[
					{type:'Input',label:'收藏时间',prop:'collectTime'},
        ],
        //查询表单内容 end
        //查询条件 start
        queryData:{
        ...
        //查询表单按钮start
        searchHandle:[
          {label:'查询',type:'primary',handle:()=>this.searchtablelist(),auth:'tweetCollect_search'},
          {label:'重置',type:'warning',handle:()=>this.resetSearch(),auth:'tweetCollect_search'}
        ],
        //查询表单按钮end
        //表格数据start
        tableData:[],
        ...
        //表格工具栏按钮 start
        tableHandles:[
          {label:'新增',type:'primary',handle:()=>this.showModal(this.commonConstants.modalType.insert),auth:'tweetCollect_insert'},
          {label:'批量删除',type:'danger',handle:()=>this.deleteBatch(),auth:'tweetCollect_batchdelete'}
        ],
        //表格工具栏按钮 end
        selectList:[],//表格选中的数据
        //表格分页信息start
        ...
        //表格列表头start
        tableCols:[
					{label:'收藏时间',prop:'collectTime',align:'center'},
					{label:'操作',prop:'operation',align:'center',type:'button',btnList:[
						{label:'查看',type:'text',auth:'tweetCollect_getdetail',handle:(row)=>this.showModal(this.commonConstants.modalType.detail,row.id)},
						{label:'编辑',type:'text',auth:'tweetCollect_update',handle:(row)=>this.showModal(this.commonConstants.modalType.update,row.id)},
						{label:'删除',type:'text',auth:'tweetCollect_delete',handle:(row)=>this.deleteOne(row.id)},
					]}
        ],
        //表格列表头end
        //modal配置 start
        ...
        //modal表单 start
        modalForm:[
					{type:'Input',label:'收藏时间',prop:'collectTime',rules:{required:true}},
        ],
        //modal表单 end
        //modal 数据 start
        modalData : {//modal页面数据
