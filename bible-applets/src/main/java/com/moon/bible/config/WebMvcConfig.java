...
import com.moon.bible.base.CurrentUserMethodArgumentResolver;
import com.moon.bible.base.CustomHttpMessageConverter;
...
public class WebMvcConfig extends WebMvcConfigurationSupport  {
     ...
     * @param converters
     * @see WebMvcConfigurationSupport#configureMessageConverters(List)
     */
    @Override
...
//        fastJsonConfig.setCharset(Charset.forName("UTF-8"));
     ...
     * @see WebMvcConfigurationSupport#addArgumentResolvers(List)
     * @author caiyang
     * @date 2020年5月14日
     */
    @Override
